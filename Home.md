...
<table>
  <tr>
    <td width="30%"><a href="https://github.com/serbanghita/Mobile-Detect/wiki/Road-to-2.9.9">Road to 2.9.9 version</a></td>
    <td>Work scheduled on the <code>2.x.x</code> branch (currently in production).</td>
  </tr>
  <tr>
...
<p><img alt="Dev status" src="https://travis-ci.org/serbanghita/Mobile-Detect.png?branch=devel" border="0"></td>
    <td>If you contribute directly to <code>Mobile_Detect.php</code> by adding some regexes make sure you write appropriate tests into <code>manual_tests/mobilePerVendor_useragents.inc.php</code>. It's easy, just fill the arrays like the ones that already exist there. Commit changes to the <code>devel</code> branch. I will merge the commits into <code>master</code> later.
      You can also add additional tests to <code>manual_tests/mobilePerVendor_useragents.inc.php</code> by adding User-Agent strings.</p>
